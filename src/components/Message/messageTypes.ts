...
const messageTypes: Record<string, { name: string, component: any }> = {
  "01": { name: "文本", component: TextMessage },
  "02": { name: "图片", component: ImageMessage },
  "03": { name: "音频", component: AudioMessage },
  "04": { name: "视频", component: VideoMessage },
  "05": { name: "链接", component: LinkMessage },
  "06": { name: "红包", component: RedEnvelopeMessage },
  "07": { name: "名片", component: CardMessage },
  "08": { name: "转账", component: TransferMessage },
  ...
  "42": { name: "位置分享", component: UnknownMessage },
  ...
  "53": { name: "视频通话", component: UnknownMessage },
  "54": { name: "视频聊天", component: UnknownMessage },
  "55": { name: "语音聊天", component: UnknownMessage },
  "56": { name: "公众号推送", component: UnknownMessage },
  "57": { name: "共享位置", component: UnknownMessage },
  ...
  "63": { name: "群公告", component: UnknownMessage },
  "64": { name: "位置信息", component: UnknownMessage },
  "65": { name: "表情", component: UnknownMessage },
  "66": { name: "系统消息", component: UnknownMessage },
  "67": { name: "商家", component: UnknownMessage },
  "68": { name: "通话", component: UnknownMessage },
  "69": { name: "记事本", component: UnknownMessage },
  "70": { name: "相册", component: UnknownMessage },
  "71": { name: "文件", component: UnknownMessage },
  ...
  "100": { name: "Dev", component: UnknownMessage }
};
