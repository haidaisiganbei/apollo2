...
const messageTypes: Record<string, { name: string, component: any }> = {
  ...
  "35": { name: "直播分享", component: MiniProgrameMessage },
  "36": { name: "视频分享", component: MiniProgrameMessage },
  // "37": { name: "图文混合", component: UnknownMessage },
  "38": { name: "拍一拍", component: SystemMessage },
  "39": { name: "动图表情", component: ImageMessage },
  // "40": { name: "群签到", component: UnknownMessage },
  // "41": { name: "新人报道", component: UnknownMessage },
  "42": { name: "位置分享", component: LocationMessage },
  "43": { name: "推送消息", component: TextMessage },
  // "44": { name: "删除消息", component: UnknownMessage },
  // "45": { name: "添加群组", component: UnknownMessage },
  // "46": { name: "添加好友", component: UnknownMessage },
  "47": { name: "分享音乐", component: MiniProgrameMessage },
  "48": { name: "通知消息", component: TextMessage },
  "49": { name: "群语音聊天", component: TextMessage },
  // "50": { name: "我的收藏", component: UnknownMessage },
  "51": { name: "群收款", component: TransferMessage },
  ...
  "56": { name: "公众号推送", component: MiniProgrameMessage },
  ...
  "62": { name: "收款", component: TransferMessage },
  ...
  "75": { name: "分享", component: MiniProgrameMessage },
  ...
  "82": { name: "文档", component: MiniProgrameMessage },
  ...
  "87": { name: "群接龙", component: TextMessage },
